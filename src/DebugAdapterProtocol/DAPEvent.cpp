...
wxDEFINE_EVENT(wxEVT_DAP_DISASSEMBLE_RESPONSE, DAPEvent);
wxDEFINE_EVENT(wxEVT_DAP_GOTO_RESPONSE, DAPEvent); //(ph 2024/11/08)
wxDEFINE_EVENT(wxEVT_DAP_GOTOTARGETS_RESPONSE, DAPEvent); //(ph 2024/11/11)
...
wxDEFINE_EVENT(wxEVT_DAP_ATTACH_RESPONSE_EVENT, DAPEvent);   // (ph 25/10/01)
