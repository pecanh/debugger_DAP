...
wxString & DapStringUtils::Rtrim(wxString & str)
{
    return str.Trim();
}

wxString & DapStringUtils::Ltrim(wxString & str)
{
    return str.Trim(false);
}

wxString & DapStringUtils::Trim(wxString & str)
{
...
wxString DapStringUtils::ToUpper(const wxString & str)
{
    return str.Upper();
}
...
wxString & DapStringUtils::ToNativePath(wxString & path)
{
    return ConvertSlashes(path, SOURCE_SEP, PATH_SEP);
}

wxString & DapStringUtils::ToUnixPath(wxString & path)
{
