...
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_DAP, wxEVT_DAP_DISASSEMBLE_RESPONSE, DAPEvent);
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_DAP, wxEVT_DAP_GOTO_RESPONSE, DAPEvent);
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_DAP, wxEVT_DAP_GOTOTARGETS_RESPONSE, DAPEvent); //(ph 2024/11/11)
...
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_DAP, wxEVT_DAP_ATTACH_RESPONSE_EVENT, DAPEvent);    // (ph 25/10/01)
